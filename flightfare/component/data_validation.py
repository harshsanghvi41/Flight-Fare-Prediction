    ...
    def validate_dataset_schema(self) -> bool:
        try:
            ...
            if sorted(train_df.columns.to_list()) == sorted(test_df.columns.to_list()) == sorted(schema_file_columns):
                ...
                # checking values of "Airline", "Source" and "Destination" in schema.yaml file
                airline_yaml_col_value = sorted(read_yaml_file(file_path = scheme_file_path)['domain_value']['Airline'])
